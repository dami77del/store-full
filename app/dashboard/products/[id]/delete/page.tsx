...
export default function Delete({params}: {params:{id:string,title:string}}) {
    return (
        <div className="h-[80vh] w-full flex items-center justify-center ">
            <Card className="max-w-xl">
                <CardHeader>
                    ...
                    <CardDescription>
                        This action cannot be undone. This permanently delete this product and remove all data from our servers
                    </CardDescription>
                </CardHeader>
